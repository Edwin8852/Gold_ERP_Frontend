  ...
  return (
    <header className="h-20 bg-white/80 dark:bg-dark-surface/80 backdrop-blur-xl border-b border-gray-100 dark:border-dark-border px-4 md:px-8 flex items-center justify-between sticky top-0 z-40">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Search Bar */}
        <div className="hidden md:flex items-center gap-3 bg-gray-50 dark:bg-dark-card px-4 py-2.5 rounded-2xl w-96 group border border-transparent focus-within:border-gold/30 transition-all">
          <Search className="text-gray-400 group-focus-within:text-gold" size={18} />
          <input 
            type="text" 
