            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {availableSchemes.map((scheme, index) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-black text-gray-900 mb-1 line-clamp-1">{scheme.schemeName}</h3>
                  <p className="text-xs text-gray-500 font-bold mb-6 line-clamp-2 min-h-[32px]">{scheme.description || 'Premium Gold Savings Plan'}</p>
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center gap-2 text-xs font-bold text-gray-500">
                      <Clock size={14} className="text-gold" /> {scheme.durationMonths} Months Duration
                    </div>
                    <div className="flex items-center gap-2 text-xs font-bold text-gray-500">
                      <Users size={14} className="text-gold" /> {scheme.maxSubscribers - scheme.currentSubscribers} Slots Available
                    </div>
                  </div>
                  ...
                  >
                    {scheme.isJoined ? 'Already Joined' : scheme.isFull ? 'Scheme Full' : 'Join Scheme'}
                  </button>
                </motion.div>
              ))}
            </div>
