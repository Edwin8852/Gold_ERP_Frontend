  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        >
          {isEditing ? (
            <>{saveLoading ? <Loader2 size={18} className="animate-spin" /> : <Save size={18} />} Save Profile</>
          ) : (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
          ...
          <p className="text-sm text-gray-500 font-medium mt-1">Customer ID: {profile?.customerCode || 'N/A'}</p>
          ...
          <div className="mt-8 w-full space-y-4">
            <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-dark-card rounded-2xl border border-transparent hover:border-gold/20 transition-all">
              ...
              <div className="text-left">
                <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest">KYC Status</p>
                <p className="text-sm font-bold text-green-500">{profile?.kycStatus || 'VERIFIED'}</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-dark-card rounded-2xl border border-transparent hover:border-gold/20 transition-all">
              <Calendar className="text-gold" size={20} />
              <div className="text-left">
                <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest">Member Since</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Input label="First Name" value={profileData.firstName || ''} onChange={(e) => setProfileData({...profileData, firstName: e.target.value})} disabled={!isEditing} icon={User} />
              <Input label="Last Name" value={profileData.lastName || ''} onChange={(e) => setProfileData({...profileData, lastName: e.target.value})} disabled={!isEditing} icon={User} />
              <Input label="Email Address" value={profileData.email || ''} onChange={(e) => setProfileData({...profileData, email: e.target.value})} disabled={!isEditing} icon={Mail} />
              <Input label="Phone Number" value={profileData.mobile || ''} onChange={(e) => setProfileData({...profileData, mobile: e.target.value})} disabled={!isEditing} icon={Phone} />
              <div className="md:col-span-2">
                 <Input 
                   label="Registered Address" 
                   defaultValue={profile?.address || "Address not provided"} 
                   disabled={!isEditing} 
                   icon={MapPin} 
                 />
              </div>
          ...
          >
            ...
            <div className="space-y-4">
               <div className="flex items-center justify-between p-4 border border-gray-100 dark:border-dark-border rounded-2xl hover:bg-gray-50 dark:hover:bg-dark-card transition-all">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                       ...
                       <p className="text-xs text-gray-500">Keep your account secure with regular updates</p>
                    </div>
                  </div>
                  <button 
               ...
               <div className="flex items-center justify-between p-4 border border-gray-100 dark:border-dark-border rounded-2xl hover:bg-gray-50 dark:hover:bg-dark-card transition-all">
                  ...
                  <button className="text-sm font-bold text-gray-400">Coming Soon</button>
               </div>
            </div>
          </motion.div>
        </div>
